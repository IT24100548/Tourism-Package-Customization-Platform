...
<head>
   ...
   <link rel="stylesheet" href="../css/style.css">
    ...
    </style>                                                                                                                                                    make this css more attractive
...
<nav class="navbar navbar-expand-lg bg-white navbar-light shadow sticky-top p-0">
    ...
    <div class="collapse navbar-collapse" id="navbarCollapse">
        <div class="navbar-nav ms-auto p-4 p-lg-0">
            <a href="${pageContext.request.contextPath}/User/index.jsp" class="nav-item nav-link">Home</a>
            ...
            <div class="col-md-6">
                <div class="register-card">
                    ...
                    <form action="${pageContext.request.contextPath}/RegisterAdminServlet" method="post">
                        <div class="mb-3">
                            <label class="form-label text-primary fw-semibold" for="username">Username</label>
                        ...
                        <div class="mb-3">
                            <label class="form-label text-primary fw-semibold" for="password">Password</label>
                            <div class="input-group">
                        ...
                        <div class="mb-4">
                            <label class="form-label text-primary fw-semibold" for="email">Email</label>
                            <div class="input-group">
                        ...
                        <div class="d-grid">
                            <button type="submit" class="btn btn-primary btn-lg rounded-pill">Register Admin</button>
                        </div>
                    </form>


                    <p class="text-center mt-3">Already have an account? <a href="Adminlogin.jsp" class="text-primary">Login</a></p>
                </div>
            </div>
        </div>
    </div>
