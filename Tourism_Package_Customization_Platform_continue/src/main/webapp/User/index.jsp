...
<nav class="navbar navbar-expand-lg bg-white navbar-light shadow sticky-top p-0">
    ...
    <div class="collapse navbar-collapse" id="navbarCollapse">
        <div class="navbar-nav ms-auto p-4 p-lg-0">
            ...
            <a href="${pageContext.request.contextPath}/Admin/registerAdmin.jsp" class="nav-item nav-link">Admins click here</a>
        ...
        <div class="row justify-content-center py-5">
            <div class="col-lg-10 pt-lg-5 mt-lg-5 text-center">
                ...
                <div class="position-relative w-75 mx-auto animated slideInDown">
                    ...
                    <a href="${pageContext.request.contextPath}/User/login.jsp" class="btn btn-outline-light py-3 px-5">User Login</a>
                    <a href="${pageContext.request.contextPath}/Admin/Adminlogin.jsp" class="btn btn-outline-light py-3 px-5">Admin Login</a>
